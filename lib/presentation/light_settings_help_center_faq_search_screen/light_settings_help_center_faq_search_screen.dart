...
class LightSettingsHelpCenterFaqSearchScreen extends StatelessWidget {
  TextEditingController stateActiveSeController = TextEditingController();

  LightSettingsHelpCenterFaqSearchScreen({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                CustomSearchView(
                  ...
                  variant: SearchViewVariant.OutlineGray800,
                  alignment: Alignment.center,
                  prefix: Container(
                    margin: getMargin(
                      left: 22,
                  ...
                  suffix: Padding(
                    ...
                    child: IconButton(
                      onPressed: stateActiveSeController.clear,
                      icon: Icon(
                        Icons.clear,
