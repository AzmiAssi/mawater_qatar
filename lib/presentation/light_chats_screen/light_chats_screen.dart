...
class LightChatsScreen extends StatelessWidget {
  const LightChatsScreen({super.key});
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text:
                                              'Can I make an offer to the price? I think the current price is too high ?',
                                          style: TextStyle(
                                            color: ColorConstant.whiteA700,
                                            fontSize: getFontSize(
                                              16,
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          "Of course you can, please make an offer. If the price is still suitable, then we will accept it 😁😁",
                          maxLines: null,
                          textAlign: TextAlign.start,
                          style: TextStyle(
                            fontSize: getFontSize(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        CustomIconButton(
                          ...
                          variant: IconButtonVariant.GradientGray500Gray503,
                          child: CommonImageView(
